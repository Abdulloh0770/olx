        ...
        <div className="row">
          <div className="col-md-4">
            <div>
              ...
              <br></br>
              <Link to={"/mobileapps"}>Помощь</Link>
              <br></br>
              <Link to={"/mobileapps"}>Платные услуги</Link>
              <br></br>
              <Link to={"/mobileapps"}>Бизнес на OLX</Link>
              <br></br>
              <Link to={"/mobileapps"}>Реклама на сайте</Link>
              <br />
              <Link to={"/mobileapps"}>Условия использования</Link>
            </div>
          </div>
          <div className="col-md-4">
            <div></div>
